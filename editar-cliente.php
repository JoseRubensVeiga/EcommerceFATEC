...
$sql = "SELECT * FROM usuarios WHERE id = $clienteId";
  ...
  <div class="d-flex">
    ...
    <div class="row w-100">
      <div class="col-12 p-5">
        <h1>Editar o cliente <?php echo $clienteId; ?></h1>
        <form method="POST" action="logica-editar-cliente.php" class="bg-light border borde-radius-3 p-4">
